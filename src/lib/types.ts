 ...
 */
export type UploadProviderFactory = (request: Request, platform?: any) => UploadProvider | null;

/**
 * Token getter function type - allows flexible token retrieval
 */
export type TokenGetter = (request: Request, platform?: any) => string | null | Promise<string | null>;
